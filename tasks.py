...
def init_static_batch() -> Dict[str, Any]:
    ...
    jobs = [
        ...
        Job(job_id="job_1", required_cpu=2.0, required_ram=4.0, duration=8, priority=JobPriority.ELEVATED, deadline=25, dependencies=[]),
        ...
        Job(job_id="job_6", required_cpu=1.5, required_ram=4.0, duration=7, priority=JobPriority.ELEVATED, deadline=24, dependencies=[]),
...
def init_priority_scheduling() -> Dict[str, Any]:
    ...
    jobs = []
    job_configs = [(1.0, 2.0, 4, JobPriority.HIGH, 12), (2.0, 4.0, 6, JobPriority.ELEVATED, 15), (1.5, 3.0, 5, JobPriority.MEDIUM, 20), (3.0, 8.0, 10, JobPriority.LOW, 30), (2.0, 5.0, 7, JobPriority.ELEVATED, 18), (1.0, 2.0, 3, JobPriority.HIGH, 10), (2.5, 6.0, 8, JobPriority.LOW, 25), (1.5, 4.0, 6, JobPriority.MEDIUM, 19), (3.5, 9.0, 12, JobPriority.LOW, 35), (1.0, 3.0, 4, JobPriority.ELEVATED, 13), (2.0, 5.0, 7, JobPriority.MEDIUM, 21), (2.5, 6.0, 8, JobPriority.HIGH, 16)]
